...
### Option 2 - Phar
Download and save the [ExtDN_Installer](https://github.com/extdn/installer-m2/raw/v1.0.0-rc6/build/extdn_installer.phar). Ensure it is executable with `chmod +x extdn_installer.phar`.
